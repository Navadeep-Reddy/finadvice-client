        ...
        <div className="bg-background-light text-walnut font-display selection:bg-olive selection:text-white overflow-x-hidden min-h-screen">
            <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
                <div className="glass-panel max-w-7xl mx-auto rounded-xl px-6 py-3 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-walnut font-bold text-lg tracking-tight">Acme Inst.</span>
                    </div>
            ...
            <section className="relative pt-32 lg:pt-48 pb-20 lg:pb-32 px-6 overflow-hidden bg-grid">
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/40 border border-white/60 backdrop-blur-sm mb-8 animate-fade-in-up">
                        ...
                        <span className="text-xs font-bold text-walnut/70 uppercase tracking-widest">Institutional Grade Infrastructure</span>
                    </div>
                    <h1 className="text-6xl lg:text-8xl font-black text-walnut tracking-tighter mb-6 leading-[0.9]">
                        Intelligence <br />
                        <span className="thermal-text shadow-glow">$2.4B</span> in Decisions
                    </h1>
                    <p className="text-xl text-walnut/70 max-w-2xl mx-auto mb-10 leading-relaxed font-light">
                        The definitive operating system for modern capital allocation. Real-time ingestion, explainable AI, and liquid-fast execution.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-20">
                        <button className="btn-liquid px-8 py-4 rounded-xl text-white text-base font-bold shadow-xl hover:shadow-2xl transition-all active:scale-95 flex items-center gap-2 cursor-pointer">
            ...
            <section className="py-24 px-6 relative">
                <div className="max-w-7xl mx-auto">
                    <div className="mb-16 text-center lg:text-left">
                        <h2 className="text-4xl font-bold text-walnut mb-4 tracking-tight">Built for Asymmetric Advantage</h2>
                        <p className="text-xl text-walnut/60 max-w-2xl">Deploy capital with the precision of machine intelligence and the intuition of human oversight.</p>
                    </div>
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 auto-rows-[minmax(300px,auto)]">
                        <div className="lg:col-span-7 glass-panel rounded-2xl p-8 lg:p-12 relative overflow-hidden group hover:bg-white/50 transition-colors">
                            <div className="relative z-10 h-full flex flex-col justify-between">
                                <div>
                                    ...
                                    <h3 className="text-2xl font-bold text-walnut mb-3">Real-time Ingestion</h3>
                                    <p className="text-walnut/70 leading-relaxed max-w-md">Process millions of data points per second. From market feeds to alternative data, ingest everything instantly.</p>
                                </div>
                                <div className="mt-8">
                                    <div className="inline-flex items-center gap-2 text-olive font-bold text-sm bg-olive/10 px-3 py-1 rounded-full">
                                        ...
                                        <span className="uppercase tracking-wider">Sub-millisecond Latency</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="lg:col-span-5 glass-panel rounded-2xl p-8 lg:p-12 relative overflow-hidden group hover:bg-white/50 transition-colors">
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-2xl font-bold text-walnut mb-3">Explainable AI</h3>
                                <p className="text-walnut/70 leading-relaxed mb-8">Black boxes are a liability. Our models provide audit-ready reasoning for every prediction and allocation suggestion.</p>
                                <div className="glass-panel p-4 rounded-lg border-l-4 border-olive">
                                    <p className="text-xs font-bold text-walnut/50 uppercase mb-1">Model Output</p>
                                    <div className="flex items-center gap-2 mb-2">
                                        <span className="text-walnut font-bold">Allocation: Short Volatility</span>
                                        <span className="bg-olive/20 text-olive text-xs font-bold px-2 py-0.5 rounded">98% Conf.</span>
                                    </div>
                                    <p className="text-xs text-walnut/60">Reasoning: VIX divergence from realized volatility exceeds 2σ threshold.</p>
                                </div>
                            </div>
                        </div>
                        <div className="lg:col-span-12 glass-panel rounded-2xl p-8 lg:p-12 flex flex-col lg:flex-row items-center gap-12 group hover:bg-white/50 transition-colors">
                            <div className="flex-1">
                                ...
                                <h3 className="text-2xl font-bold text-walnut mb-3">Institutional Security</h3>
                                <p className="text-walnut/70 leading-relaxed text-lg mb-6">SOC 2 Type II certified. End-to-end encryption. Granular RBAC permissions.</p>
                                <div className="flex flex-wrap gap-3">
                                    <span className="px-4 py-2 rounded-lg bg-white/50 border border-white/60 text-walnut/80 text-sm font-semibold">SOC 2 Type II</span>
                                    <span className="px-4 py-2 rounded-lg bg-white/50 border border-white/60 text-walnut/80 text-sm font-semibold">ISO 27001</span>
                                    <span className="px-4 py-2 rounded-lg bg-white/50 border border-white/60 text-walnut/80 text-sm font-semibold">GDPR Compliant</span>
                                </div>
                            </div>
                            <div className="w-full lg:w-1/3 flex justify-center">
                                <div className="relative w-48 h-48">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center">
                                        <span className="material-symbols-outlined text-6xl text-walnut/30">lock</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-12 border-y border-white/40 bg-white/20 backdrop-blur-sm overflow-hidden">
                <div className="max-w-7xl mx-auto px-6">
                    <p className="text-center text-sm font-bold text-walnut/40 uppercase tracking-widest mb-8">Trusted by Global Allocators</p>
                    <div className="flex flex-wrap justify-center gap-12 lg:gap-20 opacity-60 grayscale mix-blend-multiply">
                        <span className="text-2xl font-black text-walnut/60">VANGUARDIA</span>
                        <span className="text-2xl font-black text-walnut/60">BLACKROCKET</span>
                        <span className="text-2xl font-black text-walnut/60">CITADELIA</span>
                        <span className="text-2xl font-black text-walnut/60">BRIDGEWATER</span>
                        <span className="text-2xl font-black text-walnut/60">GOLDMANS</span>
                    </div>
                </div>
            </section>
            <section className="py-32 px-6">
                <div className="max-w-5xl mx-auto text-center">
                    <div className="glass-panel p-12 lg:p-20 rounded-3xl relative overflow-hidden">
                        ...
                        <h2 className="text-4xl lg:text-5xl font-bold text-walnut mb-6">Ready to upgrade your intelligence?</h2>
                        <p className="text-xl text-walnut/60 max-w-2xl mx-auto mb-10">Join the waitlist for Q4 access. Institutional accounts prioritize onboarding.</p>
                        <form className="max-w-md mx-auto flex flex-col gap-4">
                            <div className="relative">
                                <input className="w-full pl-12 pr-4 py-4 rounded-xl bg-white/60 border border-white/60 focus:ring-2 focus:ring-primary/20 focus:border-primary text-walnut placeholder-walnut/40 outline-none transition-all shadow-inner" placeholder="Work Email Address" type="email" />
                        ...
                        <p className="mt-4 text-xs text-walnut/40">No credit card required. Institutional domain validation active.</p>
                    </div>
                </div>
            </section>
            <footer className="pb-12 px-6">
                <div className="max-w-7xl mx-auto glass-panel p-8 lg:p-12 rounded-2xl flex flex-col lg:flex-row justify-between gap-12">
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-3 mb-2">
                            ...
                            <span className="text-walnut font-bold text-lg">Acme Inst.</span>
                        </div>
                        <p className="text-walnut/60 text-sm max-w-xs">Engineered for the next generation of capital markets. Precise. Liquid. Secure.</p>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-24">
                        <div className="flex flex-col gap-4">
                            ...
                            <a className="text-walnut/60 hover:text-primary transition-colors text-sm" href="#">Roadmap</a>
                        </div>
                        <div className="flex flex-col gap-4">
                ...
                <div className="max-w-7xl mx-auto mt-8 flex justify-between items-center px-4">
                    <p className="text-walnut/40 text-xs">© 2023 Acme Institutional Inc. All rights reserved.</p>
