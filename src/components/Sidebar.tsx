            ...
            <div className="glass-panel h-full w-full rounded-2xl flex flex-col justify-between p-4 lg:p-6 transition-all duration-300">
                <div className="flex flex-col gap-6 items-center lg:items-start">
                    ...
                    <div className="flex flex-col gap-2 w-full mt-6">
                        ...
                        <Link to="/credit" className={`group flex items-center gap-3 px-3 py-3 rounded-lg transition-all ${location.pathname === '/credit' ? 'bg-white/60 shadow-sm border border-white/40 hover:bg-white hover:shadow-md hover:-translate-y-0.5' : 'hover:bg-white/40'}`}>
                            <span className={`material-symbols-outlined transition-colors ${location.pathname === '/credit' ? 'text-primary' : 'text-walnut/70 group-hover:text-walnut'}`} style={{ fontSize: '24px' }}>credit_score</span>
                            <p className={`hidden lg:block text-sm font-medium ${location.pathname === '/credit' ? 'text-walnut font-semibold' : 'text-walnut/70 group-hover:text-walnut'}`}>Credit Manager</p>
                        </Link>
                    </div>
                </div>
